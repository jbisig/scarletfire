...
/**
 * The Classic Shows carousel: a hand-curated, RANKED list of 12
 * community-consensus essentials (tapers' polls, official releases,
 * Deadcast, and the broader canon). Order is editorial rank — Cornell
 * first — not chronological, so it renders via resolveCollectionShowsRanked.
 */
export const CLASSIC_SHOWS: CuratedCollection = {
  id: 'classic-shows',
  title: 'Classic Shows',
  description: 'The consensus essentials — the shows every Deadhead should hear',
  dates: [
    '1977-05-08', // Cornell, Barton Hall — consensus #1, Library of Congress registry
    '1972-08-27', // Veneta, OR — Sunshine Daydream; many rate it above Cornell
    '1970-02-13', // Fillmore East — Dick's Picks 4, the canonical Dark Star
    '1972-05-26', // Lyceum, London — Europe '72 finale
    '1970-05-02', // Harpur College — #2 in the '93 Tapers' Poll
    '1969-02-27', // Fillmore West — primary Live/Dead source
    '1973-06-10', // RFK Stadium — Deadcast: "best overall show" post-1970
    '1977-05-09', // Buffalo — Cornell's equal per many; May 1977 box
    '1977-05-07', // Boston Garden — opens the Cornell run
    '1978-12-31', // Winterland Closing — played till dawn
    '1989-07-07', // JFK Stadium — Crimson White & Indigo, peak Brent
    '1990-03-29', // Nassau — Branford Marsalis Dark Star
  ],
};
...
export const CURATED_COLLECTIONS: readonly CuratedCollection[] = [
  {
    ...
    dates: [
      ...
      '1977-05-17', // Memorial Coliseum, Tuscaloosa
      '1977-05-19', // Fox Theatre, Atlanta — Dick's Picks 29
  ...
  {
    id: 'wall-of-sound-74',
    title: "Best of Wall of Sound '74",
    description: 'The giant PA year — from Missoula to Dijon at full volume',
    dates: [
  ...
  {
    id: 'winterland-farewell-74',
    title: "Winterland Farewell '74",
    description: 'The five-night October “retirement” run behind The Grateful Dead Movie',
    dates: [
  ...
  {
    id: 'fall-80-acoustic',
    title: "Best of Fall '80 Acoustic",
