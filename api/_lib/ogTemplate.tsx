/**
 * Satori JSX template for the share card, rendered server-side by @vercel/og
 ...
 *  - Only a subset of CSS is supported (no transforms, grid, or animations)
 *  - Fonts must be loaded via ImageResponse's `fonts` option or Satori
